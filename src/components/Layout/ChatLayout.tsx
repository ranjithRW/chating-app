...
export const ChatLayout: React.FC<ChatLayoutProps> = ({ currentUser, onLogout }) => {
  ...
  return (
    <div className="h-screen flex bg-gray-100">
      ...
      <button
        onClick={() => setShowNewChatModal(true)}
        className="fixed bottom-6 right-6 md:hidden w-14 h-14 bg-green-600 hover:bg-green-700 text-white rounded-full shadow-lg flex items-center justify-center transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
      >
